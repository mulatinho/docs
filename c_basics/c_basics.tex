...
\begin{frame}
	...
	condição ou iteração, em C existem cinco palavras chamas que e
	...
	As formas mais simples de criar condições em C são através do if-else e do
	operador '?', abaixo podemos ver exemplos de suas declarações.
	...
	\only<6> {
	\framesubtitle{Loops e iterações}
