...
\begin{frame}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.4\linewidth}
			\begin{figure}
				\includegraphics[width=120]{imgs/mlt.jpg}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}[T]
		...
		\begin{column}{0.5\linewidth}
			\begin{figure}
				\includegraphics[width=150]{imgs/pdp11-70-front.jpg}
			\end{figure}
		\end{column}
	\end{columns}
...
\begin{frame}
	...
	\begin{column}{0.3\linewidth}
		\begin{figure}
			\includegraphics[width=100]{imgs/pointers.png}
		\end{figure}
	\end{column}
	\end{columns}
...
\begin{frame}[t]
	...
	\only<2>{
		...
		\begin{columns}[T]
			\begin{column}{0.4\linewidth}
				\begin{block}{Compilando programa para GDB}
			...
			\end{column}
			\begin{column}{0.6\linewidth}
				\VerbatimInput[xleftmargin=2mm,numbers=left,fontshape=sl,fontsize=\tiny]{txtz/ex05.txt}
			\end{column}
		\end{columns}
	...
	\only<3>{
		...
		Comandos básicos
		\begin{tabular}{c l}
			run & roda o programa em questão, pode usar argumentos.
			step & 
		\end{tabular}
	}
	\only<4>{
	...
	\only<7>{
		\framesubtitle{Por final, pacote binutils...}
		
		\begin{block}{Programas e significados}
		\begin{tabular}{c l}
			\scriptsize
			assert.h &  detecção de erros lógicos dentro dos programas\\
			errno.h & códigos de erro de funções de outras bibliotecas\\
