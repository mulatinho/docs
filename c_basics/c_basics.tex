...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
            ...
            irá unir todos os objetos em um único binário entendido pelo seu sistema
            operacional.
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\only<1>{
	Para que você seja eficiente desenvolvendo uma aplicação você deve obter 
...
\begin{frame}
	...
	a memória. C é simplesmente a linguagem que criou o Unix, o Linux, o C++ e 
    vários outros programas utilizados até hoje.
\end{frame}
